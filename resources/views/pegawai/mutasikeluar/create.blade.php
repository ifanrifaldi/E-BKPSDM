    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success">
                ...
                <form action="{{ url('pegawai/mutasikeluar') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="kolom_pdf_sr" name="sr" accept=".pdf" required>
                                                <label class="custom-file-label" for="kolom_pdf_sr">Pilih file PDF</label>
                                            </div>
                                            <div class="input-group-append">
                                                <span class="input-group-text bg-secondary upload-icon" data-input-id="kolom_pdf_sr"><i class="fas fa-upload"></i></span>
                                                <button type="button" class="btn btn-warning preview-btn" data-input-id="kolom_pdf_sr"><i class="fas fa-eye"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
