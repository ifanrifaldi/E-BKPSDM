                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-justify">{{ $pengaduan->nama }}</td>
                                <td class="text-justify">{{ $pengaduan->no_hp }}</td>
                                <td class="text-justify">{{ $pengaduan->jenis_pengaduan }}</td>
                                ...
                                <td class="text-center">
                                    <div class="crud-buttons">
                                        <a href="{{ url("pegawai/pengaduan/$pengaduan->id") }}" class="btn btn-secondary" title="View">
                                            <span class="fa fa-eye"></span>
                                        </a>
                                        @if($pengaduan->status !== 'Sudah Dilihat')
                                        <a class="btn btn-warning" title="Edit">
                                            <span data-toggle="modal" data-target="#modal-edit{{ $pengaduan->id }}"><span class="fa fa-edit"></span></a>
                                        <form action="{{ url('pegawai/pengaduan', $pengaduan->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <div class="modal fade" id="modal-edit{{ $pengaduan->id }}">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('pegawai/pengaduan', $pengaduan->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method("PUT")
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group row">
                                                    <select class="form-control" name="jenis_pengaduan" required>
                                                        <option value="">{{ $pengaduan->jenis_pengaduan }}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea class="form-control" name="keterangan">{{ $pengaduan->keterangan }}</textarea>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="photo-container">
                                                            ...
                                                            <embed src="{{ url("public/app/pengaduan/bukti/$pengaduan->bukti") }}" type="application/pdf" width="100%" height="350px">
                                                            @else
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="file" class="form-control" name="foto" accept=".jpg, .png, .jpeg, .pdf">
                                                    </div>
                                                </div>
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" name="no_hp" value="{{ $user->no_hp }}" hidden>
