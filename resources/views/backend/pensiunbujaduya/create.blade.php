    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success">
                ...
                <form action="{{ url('admin/pensiunbujaduya') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="no_hp" placeholder="No. HP/WA" required maxlength="13" pattern="08\d{0,11}" title="No. HP/WA harus dimulai dengan '08' dan dapat terdiri dari maksimal 13 digit angka." oninput="this.value = this.value.replace(/\D/g, '').substring(0, 13); 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="keterangan" required>
                                            ...
                                            <option value="Pensiun Dini">Pensiun Uzur</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="kolom_pdf_skbb">Pilih file PDF</label>
                                            </div>
                                            <div class="input-group-append">
                                                <span class="input-group-text bg-secondary upload-icon" data-input-id="kolom_pdf_skbb"><i class="fas fa-upload"></i></span>
                                                <button type="button" class="btn btn-warning preview-btn" data-input-id="kolom_pdf_skbb"><i class="fas fa-eye"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="kolom_pdf_skpt">Pilih file PDF</label>
                                            </div>
                                            <div class="input-group-append">
                                                <span class="input-group-text bg-secondary upload-icon" data-input-id="kolom_pdf_skpt"><i class="fas fa-upload"></i></span>
                                                <button type="button" class="btn btn-warning preview-btn" data-input-id="kolom_pdf_skpt"><i class="fas fa-eye"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="kolom_pdf_skmkp">Pilih file PDF</label>
                                            </div>
                                            <div class="input-group-append">
                                                <span class="input-group-text bg-secondary upload-icon" data-input-id="kolom_pdf_skmkp"><i class="fas fa-upload"></i></span>
                                                <button type="button" class="btn btn-warning preview-btn" data-input-id="kolom_pdf_skmkp"><i class="fas fa-eye"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="kolom_pdf_tpdh">Pilih file PDF</label>
                                            </div>
                                            <div class="input-group-append">
                                                <span class="input-group-text bg-secondary upload-icon" data-input-id="kolom_pdf_tpdh"><i class="fas fa-upload"></i></span>
                                                <button type="button" class="btn btn-warning preview-btn" data-input-id="kolom_pdf_tpdh"><i class="fas fa-eye"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
