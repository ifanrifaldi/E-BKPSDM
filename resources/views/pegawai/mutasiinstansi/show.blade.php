                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="center-buttons">
                                    ...
                                    @if($mutasiinstansi->v1 == 0)
                                    <button type="button" class="btn btn-outline-success" disabled>
                                        <i class="fas fa-question-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v1 == 1)
                                    <button type="button" class="btn btn-outline-info" disabled>
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v1 == 2)
                            ...
                            <tr>
                                ...
                                <td class="center-buttons">
                                    ...
                                    @if($mutasiinstansi->v2 == 0)
                                    <button type="button" class="btn btn-outline-success" disabled>
                                        <i class="fas fa-question-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v2 == 1)
                                    <button type="button" class="btn btn-outline-info" disabled>
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v2 == 2)
                                    <button type="button" class="btn btn-outline-danger" disabled>
                                        <i class="fas fa-times-circle"></i>
                                    </button>
                                    @endif
                            ...
                            <tr>
                                ...
                                <td class="center-buttons">
                                    ...
                                    @if($mutasiinstansi->v3 == 0)
                                    <button type="button" class="btn btn-outline-success" disabled>
                                        <i class="fas fa-question-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v3 == 1)
                                    <button type="button" class="btn btn-outline-info" disabled>
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v3 == 2)
                                    <button type="button" class="btn btn-outline-danger" disabled>
                                        <i class="fas fa-times-circle"></i>
                                    </button>
                                    @endif
                            ...
                            <tr>
                                ...
                                <td class="center-buttons">
                                    ...
                                    @if($mutasiinstansi->v4 == 0)
                                    <button type="button" class="btn btn-outline-success" disabled>
                                        <i class="fas fa-question-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v4 == 1)
                                    <button type="button" class="btn btn-outline-info" disabled>
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v4 == 2)
                                    <button type="button" class="btn btn-outline-danger" disabled>
                                        <i class="fas fa-times-circle"></i>
                                    </button>
                                    @endif
                            ...
                            <tr>
                                ...
                                <td class="center-buttons">
                                    ...
                                    @if($mutasiinstansi->v5 == 0)
                                    <button type="button" class="btn btn-outline-success" disabled>
                                        <i class="fas fa-question-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v5 == 1)
                                    <button type="button" class="btn btn-outline-info" disabled>
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v5 == 2)
                                    <button type="button" class="btn btn-outline-danger" disabled>
                                        <i class="fas fa-times-circle"></i>
                                    </button>
                                    @endif
                            ...
                            <tr>
                                ...
                                <td class="center-buttons">
                                    ...
                                    @if($mutasiinstansi->v6 == 0)
                                    <button type="button" class="btn btn-outline-success" disabled>
                                        <i class="fas fa-question-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v6 == 1)
                                    <button type="button" class="btn btn-outline-info" disabled>
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v6 == 2)
                                    <button type="button" class="btn btn-outline-danger" disabled>
                                        <i class="fas fa-times-circle"></i>
                                    </button>
                                    @endif
                            ...
                            <tr>
                                ...
                                <td class="center-buttons">
                                    ...
                                    @if($mutasiinstansi->v7 == 0)
                                    <button type="button" class="btn btn-outline-success" disabled>
                                        <i class="fas fa-question-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v7 == 1)
                                    <button type="button" class="btn btn-outline-info" disabled>
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v7 == 2)
                                    <button type="button" class="btn btn-outline-danger" disabled>
                                        <i class="fas fa-times-circle"></i>
                                    </button>
                                    @endif
                            ...
                            <tr>
                                ...
                                <td class="center-buttons">
                                    ...
                                    @if($mutasiinstansi->v8 == 0)
                                    <button type="button" class="btn btn-outline-success" disabled>
                                        <i class="fas fa-question-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v8 == 1)
                                    <button type="button" class="btn btn-outline-info" disabled>
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v8 == 2)
                                    <button type="button" class="btn btn-outline-danger" disabled>
                                        <i class="fas fa-times-circle"></i>
                                    </button>
                                    @endif
                            ...
                            <tr>
                                ...
                                <td class="center-buttons">
                                    ...
                                    @if($mutasiinstansi->v9 == 0)
                                    <button type="button" class="btn btn-outline-success" disabled>
                                        <i class="fas fa-question-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v9 == 1)
                                    <button type="button" class="btn btn-outline-info" disabled>
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v9 == 2)
                                    <button type="button" class="btn btn-outline-danger" disabled>
                                        <i class="fas fa-times-circle"></i>
                                    </button>
                                    @endif
                            ...
                            <tr>
                                ...
                                <td class="center-buttons">
                                    ...
                                    @if($mutasiinstansi->v10 == 0)
                                    <button type="button" class="btn btn-outline-success" disabled>
                                        <i class="fas fa-question-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v10 == 1)
                                    <button type="button" class="btn btn-outline-info" disabled>
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                    @elseif($mutasiinstansi->v10 == 2)
                                    <button type="button" class="btn btn-outline-danger" disabled>
                                        <i class="fas fa-times-circle"></i>
                                    </button>
                                    @endif
