    ...
    <div class="row">
        ...
        <div class="card" style="background-color: white; border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                <div class="card-header d-flex justify-content-between align-items-center" style="border-radius: 15px 15px 0 0;  background: linear-gradient(to right, #28A745, #DEE9DE, #28A745, #DEE9DE);">
                    ...
                    <a href="{{ url('admin/mutasimasuk/create') }}" class="btn btn-success ml-auto"> <span class="fa fa-plus"></span> </a>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="crud-buttons">
                                        <a href="{{ url("admin/mutasimasuk/$mutasimasuk->id") }}" class="btn btn-secondary" title="View">
                                            <span class="fa fa-eye"></span>
                                        </a>
                                        <a href="{{ url("admin/mutasimasuk/$mutasimasuk->id/edit") }}" class="btn btn-warning" title="Edit">
                                            <span class="fa fa-edit"></span>
                                        </a>
                                        <form action="{{ url('admin/mutasimasuk', $mutasimasuk->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
