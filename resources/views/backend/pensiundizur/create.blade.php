...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card card-success">
                ...
                <form action="{{ url('admin/pensiundizur') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="no_hp" placeholder="No. HP/WA" required 
                   value="08" maxlength="13" pattern="08\d{0,11}" 
                   title="No. HP/WA harus dimulai dengan '08' dan dapat terdiri dari maksimal 13 digit angka." 
