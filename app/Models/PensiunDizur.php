...
class PensiunDizur extends Model
{
    protected $table="pensiun_dizur";
    ...
    public function handleUploadFiles()
    {
        ...
        'kk','an','ac','ak','akan','skjd','skms','fpp','rekening','npwp','ktp','taspen','spbsp','cps','btdi'];
    ...
    private function handleFileUpload($fileType)
    {
        ...
        $destination = public_path("app/pensiun_dizur/{$fileType}"); // Folder sesuai dengan nama kolom
