...
{
    protected $table="mutasi_keluar_daerah";
    ...
    {
        $fileTypes = ['foto', 'sr','sum','spp', 'spdi', 'spstmtb', 'skjt', 'sk_pns', 'skp', 'skbt', 'alasan'];
    ...
    private function handleFileUpload($fileType)
    {
        ...
        $destination = public_path("app/mutasi_keluar_daerah/{$fileType}"); // Folder sesuai dengan nama kolom
