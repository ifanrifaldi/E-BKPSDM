            ...
            <div class="row">
                ...
                <div class="col-md-6 order-md-1">
                    ...
                    <div class="data-container">
                        <div class="row">
                            <div class="col-12">
                                <a href="{{ url('pegawai/mutasikeluar') }}" class="btn btn-success back-button"><i class="fa fa-arrow-left"></i></a>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <button class="btn btn-success pdf-button" onclick="showPDF('{{ url("public/app/mutasi_keluar_daerah/spm/$mutasikeluar->spm") }}')">
