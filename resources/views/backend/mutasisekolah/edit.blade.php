    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success">
                ...
                <form action="{{ url('admin/mutasisekolah/'.$mutasisekolah->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" name="status" value="{{$mutasisekolah->status}}" hidden>
                                    <input type="text" class="form-control" name="pesan" value="{{$mutasisekolah->pesan}}" hidden>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="no_hp" placeholder="No. HP/WA" value="{{ substr($mutasisekolah->no_hp, 0, 2) === '08' ? $mutasisekolah->no_hp : '08' }}" required maxlength="13" pattern="08\d{0,11}" title="No. HP/WA harus dimulai dengan '08' dan dapat terdiri dari maksimal 13 digit angka." oninput="this.value = this.value.replace(/\D/g, '').substring(0, 13); 
