    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success">
                ...
                <form action="{{ url('admin/mutasikeluar/'.$mutasikeluar->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" name="status" value="{{$mutasikeluar->status}}" hidden>
                                    <input type="text" class="form-control" name="pesan" value="{{$mutasikeluar->pesan}}" hidden>
