    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success">
                ...
                <form action="{{ url('pegawai/mutasisekolah') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="no_hp" placeholder="No. HP/WA" required maxlength="13" pattern="08\d{0,11}" title="No. HP/WA harus dimulai dengan '08' dan maksimal 13 digit." oninput="this.value = '08' + this.value.slice(2).replace(/\D/g, '').substring(0, 11);">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="kolom_pdf_rkdp" name="rkdp" accept=".pdf" required>
                                                <label class="custom-file-label" for="kolom_pdf_rkdp">Pilih file PDF</label>
                                            </div>
                                            <div class="input-group-append">
                                                <span class="input-group-text bg-secondary upload-icon" data-input-id="kolom_pdf_rkdp"><i class="fas fa-upload"></i></span>
                                                <button type="button" class="btn btn-warning preview-btn" data-input-id="kolom_pdf_rkdp"><i class="fas fa-eye"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
